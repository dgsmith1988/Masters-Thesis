...
An object moving along a wound string creates a repeated force excitation to the string based on its velocity as well as the texture of the string's surface \citetwo{pakarinen_analysis_2007}. A finger moving along a wound string might therefore be approximated by:
