...
%         minString_f0 = SystemParams.E_string_params.f0;
        maxString_f0 = SystemParams.e_string_params.f0;
        ...
        %Relative strength of harmonics (in dB) for Harmonic Resonator Bank
        h_dB = [0 -2.5 -5 -7.5 -10 -12.5];
    end
end
